...
window.admitCardTemplateEvents = {
    'click .edit-data': function (e, value, row) {
        $('#id').val(row.id);
    }
};
...
window.studentEvents = {
    'click .edit-data': function (e, value, row) {
        ...
        $('#edit_dob').val(moment(row.user.dob, schoolSettingsDateFormat).format(schoolSettingsDateFormat));
...
window.staffEvents = {
    'click .edit-data': function (e, value, row) {
        ...
        $('#edit_joining_date').val(moment(row.staff.joining_date, jsReplacedDateFormat).format('DD-MM-YYYY'));
...
window.driverHelperEvents = {
    'click .edit-data': function (e, value, row) {
        ...
        $('.edit-dob').val(moment(row.dob, momentFormat).format(momentFormat));

        $('#edit_joining_date').val(moment(row.staff.joining_date, momentFormat).format(momentFormat));
