...
use App\Http\Controllers\AdmitCardTemplateController;
...
Route::post(
    '/settings/student-id-card/label-save',
    [SchoolSettingController::class, 'saveStudentIdCardLabel']
)->name('student.id.card.label.save');
Route::post('id-card-settings/label-save', [SchoolSettingsController::class, 'saveStudentIdCardLabel'])->name('id-card-settings.label-save');
        ...
        Route::group(['prefix' => 'seat-number'], static function () {
            Route::get('/', [SeatNumberController::class, 'index'])->name('seat-number.index');
            Route::get('generate', [SeatNumberController::class, 'generate'])->name('seat-number.generate');
            Route::get('design', [SeatNumberController::class, 'design'])->name('seat-number.design');
            Route::any('save-template', [SeatNumberController::class, 'saveTemplate'])->name('seat-number.save-template');
            Route::post('print', [SeatNumberController::class, 'print'])->name('seat-number.print');
        });
        ...
        // Admit Cards
        Route::group(['prefix' => 'admit-card-template'], static function () {
            Route::get('design/{id}', [AdmitCardTemplateController::class, 'design'])->name('admit-card-template.design');
            Route::put('design/{id}', [AdmitCardTemplateController::class, 'design_store'])->name('admit-card-template.design.store');
        });

        Route::group(['prefix' => 'admit-card'], static function () {
            Route::get('/', [AdmitCardTemplateController::class, 'admitCard']);
            Route::post('/', [AdmitCardTemplateController::class, 'admitCard_generate']);
        });
        Route::resource('admit-card-template', AdmitCardTemplateController::class);
        
        // Report Card Templates
        Route::group(['prefix' => 'report-card-template'], static function () {
            Route::get('design/{id}', [ReportCardTemplateController::class, 'design'])->name('report-card-template.design');
            Route::put('design/{id}', [ReportCardTemplateController::class, 'design_store'])->name('report-card-template.design.store');
        });

        Route::group(['prefix' => 'report-card'], static function () {
            Route::get('/', [ReportCardTemplateController::class, 'generate_report'])->name('report-card.generate');
            Route::post('/', [ReportCardTemplateController::class, 'generate_report'])->name('report-card.generate.post');
        });
        Route::resource('report-card-template', ReportCardTemplateController::class);
        ...
        Route::group(['prefix' => 'reports/exam'], static function () {
            ...
            Route::get('get-all-student-ids', [ReportsController::class, 'getAllStudentIdsForBulkPrint'])->name('reports.exam.get-all-student-ids');
            Route::get('bulk-print-all-students', [ReportsController::class, 'bulkPrintAllStudentsPdf'])->name('reports.exam.bulk-print-all-students');
            Route::get('bulk-download-selected-pdfs', [ReportsController::class, 'bulkDownloadSelectedPdfs'])->name('reports.exam.bulk-download-selected-pdfs');
            ...
            Route::get('rank-wise-top-performers', [ReportsController::class, 'rankWiseTopPerformers'])->name('reports.exam.rank-wise-top-performers');
              // Report Card Template PDF Routes
            Route::get('bulk-print-report-card', [ReportsController::class, 'bulkPrintReportCard'])->name('reports.exam.bulk-print-report-card');
            Route::get('print-selected-report-card', [ReportsController::class, 'printSelectedReportCard'])->name('reports.exam.print-selected-report-card');
        });
    });
