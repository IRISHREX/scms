...
<head>
    ...
    <style>
        ...
        .grade-system-table {
            ...
            border-collapse: collapse;
            border: 1px solid #0084a9;
            /* same border color as grades-table */
            border-radius: 6px;
            overflow: hidden;
            box-shadow: 0 2px 6px rgba(0, 0, 0, 0.05);
            margin-top: 15px;
    ...
    <div class="report-card">
        ...
        <div class="content-section border-top">
            ...
            <table class="table table-bordered table-sm mb-2" style="font-size: 9pt;">
                <tbody>
                    <tr>
                        <td><strong>Student Name :</strong> {{ $result->user->first_name }}
                    ...
                    <tr>
                        <td><strong>Guardian Name :</strong>
                            {{ $result->user->student->guardian->full_name ?? $result->user->student->father_name ?? '-' }}
                        </td>
                        <td><strong>Class :</strong> {{ $result->class_section->full_name }}</td>
                        <td><strong>Exam Name :</strong> {{ $result->exam->name ?? '-' }}</td>
                    </tr>
                    <tr>
                        <td colspan="2"><strong>Session Year :</strong> {{ $result->session_year->name ?? '-' }}</td>
                            ...
                            @foreach ($exams as $exam)
                                ...
                                @if (!empty($types))
                                    ...
                                    <td>
                                        @php
                                            $grade = '';
                                            $percentage = $exam_subject_total; // Assuming total marks is 100 for grade calculation
                                            foreach ($grades as $g) {
            ...
            <div class="two-columns">
                <div class="column">
                    ...
                    <div class="activity-grade-box"
                        ...
                        <div style="flex: 1; font-weight: 600; font-size: 11px;">ACTIVITY</div>
                        <div style="width: 70px; text-align: center; font-weight: 600; font-size: 11px;">GRADE</div>
                    </div>
                    ...
                    <div class="activity-content"
                        ...
                        <div class="percentage-circle"
                            ...
                            <div class="percentage-label"
                                style="font-size: 8px; text-transform: uppercase; color: var(--dark);">Overall
                            </div>
                        </div>

                        <!-- Center: Attendance Info -->
        ...
        <div class="footer d-flex justify-content-between align-items-center"
            style="font-size: 10px; border-top: 1px solid #0d6efd;">
            <div class="issued-date">Issued Date: {{ date('d-M-Y') }}</div>
            <div class="flex-grow-1 text-center">&copy; Driven by Demo School</div>
