            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ url('admit-card') }}" id="formdata" class="pt-3" target="_blank" method="post">
                            @csrf

                            <div class="row">
                                <div class="form-group col-sm-12 col-md-3">
                                    <label class="filter-menu">{{ __('admit_card') }} {{ __('template') }} <span class="text-danger">*</span> </label>
                                    {!! Form::select('admit_card_template_id', $admitCardTemplates, null, ['class' => 'form-control','id' => 'admit_card_template_id', 'placeholder' => 'Select '.__('admit_card').' '.__('template'), 'required' => 'required']) !!}
                                </div>
                                
                                <div class="form-group col-sm-12 col-md-3">
                                    <label class="filter-menu">{{ __('exam') }} <span class="text-danger">*</span> </label>
                                    <select name="exam_id" class="form-control" id="exam_id" class="form-control" required>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <table aria-describedby="mydesc" class='table table-responsive' id='table_list'
                                       ...
                                       <th scope="col"
    data-field="class_section.full_name"
    data-formatter="classSectionFormatter">
    {{ __('class_section') }}
</th>
...
@endsection
@section('script')
    <script>function classSectionFormatter(value, row, index) {
    if (!value) return '';
