...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="exam-menu">
                    <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('seat-number.index') }}" class="nav-link"
                                data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('Exam Management')">
                                {{ __('Seat Generation') }}
                            </a>
                        </li>
        ...
        @canany(['route-list', 'pickup-points-list', 'vehicles-list', 'RouteVehicle-list', 'driver-helper-list', 'transportationRequests-list', 'transportationexpense-list'])
            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="report-menu">
                        <ul class="nav flex-column sub-menu">
                            ...
                            @endcan
                            <li class="nav-item">
                                <a href="{{ url('report-card-template') }}" class="nav-link">
                    ...
                    <ul class="nav flex-column sub-menu">
                        ...
                        @endcanany
                         ...
                         @canany(['certificate-list'])
                            <li class="nav-item">
                                <a href="{{ url('admit-card') }}" class="nav-link"
                                    data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('ID Card - Certificate Generation')">
