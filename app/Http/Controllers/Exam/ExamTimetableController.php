        ...
        try {
            ...
            if (!empty($users)) {
                try {
                    ...
                    ResponseService::logErrorResponse($notificationError, "Exam Timetable Controller -> Notification Error");
            ...
            ResponseService::errorResponse('Error Occurred', null, 103, $e);
        }
    }
