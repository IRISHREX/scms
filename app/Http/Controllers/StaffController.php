...
class StaffController extends Controller
{
    ...
    public function generate_staff_id_card(Request $request)
    {
        ...
        try {
            ...
            $settings['staff_page_height_px'] = ($settings['staff_page_height'] * 3.7795275591) . 'px';
            $settings['staff_page_width_px'] = ($settings['staff_page_width'] * 3.7795275591) . 'px';
            $settings['staff_cards_per_page'] = $cardsPerPage;
