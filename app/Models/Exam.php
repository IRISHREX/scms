...
class Exam extends Model {
    ...
    public function getLastResultSubmissionDateAttribute()
    {
        if ($this->last_result_submission_date ?? null) {
            return $this->formatDateOnly($this->last_result_submission_date);
        }
        return null;
    }
}
